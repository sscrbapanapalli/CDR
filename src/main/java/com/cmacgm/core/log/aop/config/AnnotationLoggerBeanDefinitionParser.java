...
import com.cmacgm.core.log.aop.AOPLogger;
import com.cmacgm.core.log.aop.SimpleLogAdapter;
import com.cmacgm.core.log.aop.UniversalLogAdapter;
...
public class AnnotationLoggerBeanDefinitionParser extends AbstractBeanDefinitionParser {
    ...
    private static final String INTERNAL_AOPLOGGER_NAME = "com.cmacgm.core.log.aop.internal.aoplogger.name";
